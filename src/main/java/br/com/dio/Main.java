...
import br.com.dio.exception.NoFundsEnoghException;
...
public class Main {
    ...
    private static void withdraw(){
        ...
        } catch (NoFundsEnoghException | AccountNotFoundException ex){
    ...
    private static void checkHistory(){
        System.out.println("Informe a chave da conta pix para verificar o extrato: ");
        var pix = scanner.next();
